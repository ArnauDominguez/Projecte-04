...
El client ha insistit que treballa **sense un entorn d’autenticació centralitzada** i que, de moment, no té previst fer aquest pas.
...
* **Network File System (NFS)**. (s. f.). *Ubuntu Server Documentation*
